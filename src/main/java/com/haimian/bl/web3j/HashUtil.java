...
public class HashUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(md5(a.getBytes()));
        System.out.println(sha1(a.getBytes()));
        System.out.println(sha256(a.getBytes()));
        System.out.println(sha512(a.getBytes()));
        System.out.println(ripemd160(a.getBytes()));
        System.out.println("========以下是输入16进制字节数组返回16进制的摘要=======");
        byte[] hexByte = hexStr2HexBytes(a);
